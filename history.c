...
int storia[500];
int sp=0;
while(a != 8){  //INPUT nella funzione di input va aggiunta la logica per la funzione storia. 
//creare una funzione che dato l'input faccia un parsing e lo porti sulla storia. PareToHistory(input,storia)
...
//funzione undo, legge la storia e ne fa l'opposto aggiornato il ponter undo(gapbuf, history)
    int ctrlz = 0;
